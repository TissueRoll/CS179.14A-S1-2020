...
void initializeSettings() {
    if (readFromAvailableText()) {
        std::cout << "hw5-rev_settings.txt successfully loaded.\n";
    } else {
        std::cout << "hw5-rev_settings.txt not loaded. Using default values.\n";
...
int main () {
    srand(time(NULL));
    sf::RenderWindow window(sf::VideoMode(window_w, window_h), "HW 5");
